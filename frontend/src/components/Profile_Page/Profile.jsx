...
const Profile = () => {
  ...
  // Fetch user data from /api/v1/user/me
  useEffect(() => {
  ...
  const handleRemoveSkill = (index) => {
    setFormData({
      ...
      profile: {
        ...formData.profile,
        skills: formData.profile.skills.filter((_, i) => i !== index),
      },
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Re-fetch user data to update form
        const meResponse = await fetch("http://localhost:8080/api/v1/user/me", {
        ...
        if (meResponse.ok) {
          ...
          setFormData({
            ...
            profile: {
              ...
              resumeUrl: meData.profile?.resumeUrl || "",
              companyId: meData.profile?.companyId || "",
            },
          });
        }
      } else {
                    ...
                    <li>
                      <span className={styles.spans}>
                        ...
                        >
                          <g fill="none" fillRule="evenodd">
                            <path
                              d="M28 16.1c-2-1.3-4.4-2.1-7-2.1-7.2 0-13 5.8-13 13s5.8 13 13 13 13-5.8 13-13c0-1.273-.192-2.499-.54-3.653a12.93 12.93 0 00-1.083-2.553"
                              fill="#FFF"
                            ></path>
                            <path
                              d="M28 16.1c-2-1.3-4.4-2.1-7-2.1-7.2 0-13 5.8-13 13s5.8 13 13 13 13-5.8 13-13c0-1.273-.192-2.499-.54-3.653a12.93 12.93 0 00-1.083-2.553"
                            ...
                            ></path>
                            <path
                              d="M21 34.429a7.429 7.429 0 110-14.858 7.429 7.429 0 010 14.858zM21 30a3 3 0 100-6 3 3 0 000 6z"
                              fill="#DFF7E7"
                            ></path>
                            <path
                              d="M24.157 20.221c-.928-.464-2.043-.65-3.157-.65-4.086 0-7.429 3.343-7.429 7.429s3.343 7.429 7.429 7.429 7.429-3.343 7.429-7.429c0-.555-.07-1.086-.185-1.607a10.35 10.35 0 00-.207-.782m7.213-11.362L21.75 26.75"
                              stroke="#0CAA41"
                              strokeWidth="2"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                            ></path>
                            <path
                              d="M31.87 10.23l5.19-4.953c.636-.608 1.69-.157 1.69.723v3.25a.5.5 0 00.5.5h3.25c.902 0 1.343 1.1.691 1.723l-5.46 5.222a2 2 0 01-1.382.555h-4.093a1 1 0 01-1-.999l-.005-4.571a2 2 0 01.619-1.45z"
                              fill="#0CAA41"
                              fillRule="nonzero"
                            ></path>
                          </g>
                      ...
                      <span className={styles.spans}>
                        ...
                        >
                          <g fill="none" fillRule="evenodd">
                            ...
                            <path
                              fill="#0CAA41"
                              d="M18 18.667a1.667 1.667 0 110-3.334 1.667 1.667 0 010 3.334zm-3.144 2.221a3.335 3.335 0 016.288 0A4.98 4.98 0 0118 22a4.98 4.98 0 01-3.144-1.112z"
                            ></path>
                            <path
                              stroke="#0CAA41"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              strokeWidth="2"
                              d="M25.35 14h6.3m-6.317 4h6.317M14.7 25.5h12.6m-12.633 4H22m-7.3 4h12.6"
                            ></path>
                            <g strokeWidth="2">
                              <circle
                                cx="32.5"
                  ...
                  <div className={styles.profile_body_right}>
                    ...
                    <form onSubmit={handleSubmit} className={styles.update_form}>
                          ...
                          {formData.profile.skills.map((skill, index) => (
                            <div key={index} className={styles.skill_item}>
                              ...
                              <button
                                ...
                                className={styles.remove_skill_button}
                              >
                                ×
                              </button>
                            </div>
                      ...
                      {formData.role === "RECRUITER" && (
                        <div className={styles.input_group}>
                          <label htmlFor="profile.companyId">Company ID</label>
                          <input
                            type="text"
                            id="profile.companyId"
                            name="profile.companyId"
                            value={formData.profile.companyId}
                            onChange={handleChange}
                    ...
                    <div>
                      <span>
                        ...
                        >
                          <g fill="none" fillRule="evenodd">
                            <path
                              d="M16.4 22.476a8.036 8.036 0 002.33 2.734 13.742 13.742 0 00-6.856 5.518 12.581 12.581 0 01-5.624-2.784 8.805 8.805 0 018.25-5.671c.652 0 1.287.07 1.9.203zm17.1-.203c3.778 0 7 2.358 8.25 5.671a12.58 12.58 0 01-6.526 2.94 13.739 13.739 0 00-6.953-5.674 8.04 8.04 0 002.136-2.384 8.855 8.855 0 013.093-.553zm-19-10.182c1.215 0 2.318.482 3.127 1.264a7.972 7.972 0 00-2.127 5.433c0 .733.099 1.443.283 2.117a4.5 4.5 0 11-1.283-8.814zm19 0a4.5 4.5 0 11-2.189 8.433c.124-.56.189-1.14.189-1.736a7.97 7.97 0 00-1.636-4.849 4.494 4.494 0 013.636-1.848z"
                              fill="#DFF7E7"
                            ></path>
                            <path
                              d="M23.5 26.364c5.037 0 9.334 3.144 11 7.561A16.793 16.793 0 0123.5 38a16.793 16.793 0 01-11-4.075c1.666-4.417 5.963-7.561 11-7.561zm0-13.576a6 6 0 110 12 6 6 0 010-12zm-.05 8.629a.803.803 0 00-.813.793c0 .44.366.792.813.792a.803.803 0 00.813-.792.803.803 0 00-.813-.793zm0-6c-1.014 0-1.906.637-2.156 1.373-.28.826.766 1.26 1.23.51.253-.408.568-.593.926-.593.651 0 .993.287.98.73.005.332-.12.511-.5.805l-.224.17c-.625.49-.916.96-.916 1.798 0 .358.298.645.66.645.363 0 .66-.287.66-.645.037-.532.202-.761.72-1.164l.015-.011c.66-.513.905-.88.905-1.69 0-1.16-1.039-1.928-2.3-1.928z"
                              fill="#0CAA41"
                            ></path>
                          </g>
                        </svg>
