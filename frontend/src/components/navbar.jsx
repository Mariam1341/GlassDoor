import styles from './navbar.module.css'; // Changed 'Navbar' to 'navbar'
...
export function Navbar() {
    ...
    const handleTogglePopup = () => {
        setUserSettingPopupStyle(userSettingPopupStyle === "none" ? "block" : "none");
    };

    const handleMenuItemClick = () => {
        setUserSettingPopupStyle("none");
    };
    ...
    return (
        <div>
            ...
            <div className={styles.container}>
                <div className={styles.navbarCont}>
                    ...
                    <div className={styles.profileSvg}>
                        <span ref={profileRef} onClick={handleTogglePopup}>
                            <svg
                                style={{
                                    width: "40px",
                                    height: "40px",
            ...
            <div
                ...
                style={{ display: userSettingPopupStyle }}
            >
                <ul>
                    <Link to="/Profile" onClick={handleMenuItemClick}>
                        <li>Profile</li>
                    </Link>
                    <li onClick={handleMenuItemClick}>CVs</li>
                    <li onClick={handleMenuItemClick}>Job Preferences</li>
                </ul>
                <ul>
                    <li onClick={handleMenuItemClick}>Contributions</li>
                    <li onClick={handleMenuItemClick}>Company Follows</li>
                    <li onClick={handleMenuItemClick}>Email & Alerts</li>
                </ul>
                <ul>
                    <li onClick={handleMenuItemClick}>Account Setting</li>
                </ul>
                <ul style={{ borderBottom: "none" }}>
                    <li onClick={handleMenuItemClick}>Help Center</li>
